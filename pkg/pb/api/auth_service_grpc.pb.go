...
type AuthServiceClient interface {
	Register(ctx context.Context, in *RegisterRequest, opts ...grpc.CallOption) (*GenericResponse, error)
...
func (c *authServiceClient) Register(ctx context.Context, in *RegisterRequest, opts ...grpc.CallOption) (*GenericResponse, error) {
...
type AuthServiceServer interface {
	Register(context.Context, *RegisterRequest) (*GenericResponse, error)
...
func (UnimplementedAuthServiceServer) Register(context.Context, *RegisterRequest) (*GenericResponse, error) {
